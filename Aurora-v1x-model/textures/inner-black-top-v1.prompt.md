...
## Collarbone coverage: v5

フードを外した状態で鎖骨まわりを再確認し、v4の細い表示幅を上半身まで一定にすると
ジャケットの襟脇から肌が見える余地があるため、`inner-black-top-v5.png`を作成しました。

前後それぞれの上端ではx=380〜644まで黒インナーを広げ、ローカルy=360〜500の間で
段階的にv4のx=445〜579へ絞っています。胴側の貫通防止幅は維持しつつ、首・鎖骨・胸上部を
黒インナーで覆う構成です。統合トップスはv5へ差し替えて保存済みです。
